...
public struct AnyCodable: Codable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .date(let d): try c.encode(ISO8601DateFormatter.meridianFormatter.string(from: d))
        case .dateTime(let d): try c.encode(ISO8601DateFormatter.meridianFormatter.string(from: d))
