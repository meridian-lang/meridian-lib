...
public enum RESOLVER {
    ...
    public struct ResolverInput: MeridianWorkflow {
        ...
        public static let skillMetadata: [String: String] = [
            "name": "resolver",
            "description":
                "The skill dispatcher. Routes an inbound request to the skill that owns it. Skills are the implementation; the resolver only selects. When two skills could match, read both — they are designed to chain (for example, ingest then enrich for each entity).",
